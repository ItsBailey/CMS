                                ...
                                <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
                                    <tr>
                                        ...
                                        <td class="tablerow2"  width="30%"  valign="middle">
                                            <input type="number" name="pincode" value="{$staffPin}" min="1000" max="9999" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tablerow1"  width="20%"  valign="middle">
                                        ...
                                        <td class="tablerow2"  width="30%"  valign="middle">
                                            <input type="text" name="specialrank" value="{$staffRank}" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tablerow1"  width="20%"  valign="middle">
                                        ...
                                        <td class="tablerow2"  width="30%"  valign="middle">
                                            <input type="text" name="title" value="{$staffTitle}" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="tablerow1"  width="20%"  valign="middle">
                                        ...
                                        <td class="tablerow2"  width="30%"  valign="middle">
                                            <textarea name="story">{$staffStory}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
