                                                            ...
                                                            <div class="homepage_border">
                                                                ...
                                                                <table width="100%" cellpadding="4" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="homepage_sub_row" width="40%"><strong>{$cmsP} :: {$cmsV}-{$cmsB}</strong>&nbsp;</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>Spelers</strong></td>
                                                                        <td class="homepage_sub_row"><strong>{function="Core::countData($users)"}</strong> spelers, waarvan er <strong>{$onlineCount}</strong> online zijn</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>Kamers</strong></td>
                                                                        <td class="homepage_sub_row"><strong>{function="Core::countData('rooms')"}</strong> kamers aangemaakt</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>Meubels</strong></td>
                                                                        <td class="homepage_sub_row"><strong>{function="Core::countData('items')"}</strong> meubels in het hotel</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>Groepen</strong></td>
                                                                        <td class="homepage_sub_row"><strong>{function="Core::countData($guilds)"}</strong> groepen aangemaakt</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>Stafflogs</strong></td>
                                                                        <td class="homepage_sub_row"><strong>{function="Core::countData('cms_stafflog')"}</strong> medewerker logs</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>Verbanningen</strong></td>
                                                                        <td class="homepage_sub_row"><strong>{function="Core::countData('bans')"}</strong> mensen verbannen</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </td>
                                                            ...
                                                            <div class="homepage_border">
                                                                ...
                                                                <table width="100%" cellpadding="4" cellspacing="0">
                                                                    <tr>
                                                                        ...
                                                                        <td class="homepage_sub_row">{function="Core::getSystem('ip')"}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>Hotel poort</strong></td>
                                                                        <td class="homepage_sub_row">{function="Core::getSystem('port')"}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td class="homepage_sub_row"><strong>MUS poort</strong></td>
                                                                        <td class="homepage_sub_row">{function="Core::getSystem('musport')"}</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </td>
                                    ...
                                    <div class="homepage_pane_border" id="acp-update-normal">
                                        ...
                                        <div style="font-size:12px;padding:4px; text-align:center">
                                            <p>
                                                ...
                                                <strong>{$cmsP} :: {$cmsV}-{$cmsB}</strong><br /><br />
                                    ...
                                    <div class="homepage_pane_border" id="acp-update-normal">
                                        ...
                                        <div style="font-size:12px;padding:4px; text-align:center">
                                            <p>
                                                ...
                                                Bedankt voor het gebruik van AcellCMS {$cmsV}<br />
