...
<div id="ipdwrapper">
                                        ...
                                        <tr>
                                            <td width="200" class="tablerow1" valign="top" style="border:0px;width:200px">
                                                <div style="text-align:center;padding-top:20px">
                                                    <img src="<?php echo $siteLink;?><?php echo $cmsTemplateStyle;?>/images/acp-login-lock.gif" alt="Housekeeping" border="0" />
                                                </div><br />
                                            ...
                                            <td width="300" style="width:300px" valign="top">
                                                <table width="100%" cellpadding="5" cellspacing="0" border="0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                          <input type="text" name="username" value="<?php echo $userName;?>" style="border:1px solid #AAA" />
                                                        </td>
                                                    </tr>
                                                    <tr>
    ...
    <div class="copy" align="center">AcellCMS <?php echo $cmsV;?>-<?php echo $cmsB;?> [<?php echo $cmsP;?>] <br />
