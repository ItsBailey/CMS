                                ...
                                <table cellpadding="4" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td class="tablerow2" width="60%" valign="middle">
                                            <select name="rankid">
                                                <option value="1">1, <?php echo Cms::getRankName(1); ?></option>
                                                <option value="2">2, <?php echo Cms::getRankName(2); ?></option>
                                                <option value="3">3, <?php echo Cms::getRankName(3); ?></option>
                                                <option value="4">4, <?php echo Cms::getRankName(4); ?></option>
                                                <option value="5">5, <?php echo Cms::getRankName(5); ?></option>
                                                <option value="6">6, <?php echo Cms::getRankName(6); ?></option>
                                                <option value="7">7, <?php echo Cms::getRankName(7); ?></option>
                                                <option value="8">8, <?php echo Cms::getRankName(8); ?></option>
                                                <option value="9">9, <?php echo Cms::getRankName(9); ?></option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
