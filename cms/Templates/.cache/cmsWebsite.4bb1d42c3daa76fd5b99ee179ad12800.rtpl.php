                                ...
                                <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
                                    <tr>
                                        ...
                                        <td class="tablerow2" width="60%" valign="middle">
                                            <input type="text" name="hotelname" size="30" value="<?php echo $siteShort;?>" class="textinput" /> Hotel
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="tablerow2" width="60%" valign="middle">
                                            <input type="text" name="hotelowner" size="30" value="<?php echo $hotelOwner;?>" class="textinput" />
                                        </td>
                                    </tr>
                                    <tr>
