            ...
            <div id="content">
                <div id="column1" class="column">
                    <div class="habblet-container">
                        <div id="new-personal-info" style="background-image:url({$siteTemplateStyle}v2/images/personal_info/hotel_views/htlview_br.png)">
                            <div id="enter-hotel">
                                {$onlineOfflineMe}
                            </div>
                            <div id="habbo-plate">
                                <a href="settings">
                                    <img alt="{$userName}" src="http://www.habbo.nl/habbo-imaging/avatarimage?figure={$userLook}&headonly=0&direction=2&head_direction=3&action=wav&gesture=sml&size=m" width="64" height="110" />
                                </a>
                            </div>
                            <div id="habbo-info">
                                <div id="motto-container" class="clearfix">
                                    ...
                                    <div>
                                        <span title="Wijzig je motto">{$userMotto}</span>
                                        <p style="display: none">
                                            <input type="text" length="30" name="motto" value="{$userMotto}" />
                                        </p>
                                    </div>
                                </div>
                            ...
                            <ul id="link-bar" class="clearfix">
                                <li class="credit"><a href="javascript:(void)"><b>{$userCredits}</b> Credits</a></li>
                                <li class="pixel"><a href="javascript:(void)"><b>{$userPixels}</b> Pixels</a></li>
                                <li class="diamond"><a href="javascript:(void)"><b>{$userPoints}</b> Diamanten</a></li>
                            </ul>
                            <div id="habbo-feed">
                                <ul id="feed-items">
                                    {$feedNotifyPincode}
                                    {$feedNotifyMaintenance}
                                    <li class="small" id="feed-lastlogin">
                                        Laatst ingelogd op: {$userLastLogin}
                                    </li>
                                </ul>
                            </div>
                            <p class="last"></p>
                    ...
                    <div class="habblet-container">
                        <div class="cbb clearfix default">
                            <div class="box-tabs-container clearfix">
                                <h2>{$siteShort} vrienden</h2>
                                <ul class="box-tabs">
                                    <li id="tab-0-4-1"><a href="#">Zoek {$siteShort}'s</a><span class="tab-spacer"></span></li>
                            ...
                            <div id="tab-0-4-1-content" style="display: none">
                                <div class="habblet-content-info">
                                    <a name="habbo-search">Typ de eerste paar karakters van de {$siteShort} die je wilt zoeken..</a>
                                </div>
                                ...
                                <div id="friend-invitation-habblet-container" class="box-content">
                                    <div style="display: none">
                                        <div id="invitation-form" class="clearfix">
                                            <textarea name="invitation_message" id="invitation_message" class="invitation-message">Come and hangout with me in {$siteName}. -  {$userName} </textarea>
                                    ...
                                    <div id="invitation-link-container">
                                        <h3>{$siteShort} is leuker met wat échte vrienden!</h3>
                                        <div class="copytext">
                                            <p>
                    ...
                    <div class="habblet-container">
                        <div class="cbb clearfix green">
                            ...
                            <div id="tab-3-1-content" style="display: none">
                                <div class="progressbar"><img src="{$siteTemplateStyle}images/progress_bubbles.gif" alt="" width="29" height="6" /></div>
                                <a href="{$siteTemplate}habblets/tagcloud?cloud=plain" class="tab-ajax"></a>
                            </div>
                                    ...
                                    <div class="box-content">
                                        <div class="habblet" id="my-tags-list">
                                            <ul class="tag-list make-clickable">
                                                {function="incWeb::tagList($userID)"}
                                            </ul>
                                            <form method="POST" action="{$siteTemplate}habblets/tags?key=add" onsubmit="TagHelper.addFormTagToMe(); return false;">
