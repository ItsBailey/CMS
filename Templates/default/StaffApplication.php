        ...
        <div id="container">
            <div id="content">
                <div id="column1" class="column">
                    {function="incWeb::staffApplication($id)"}
                    {$tplRounder}
                </div>
                ...
                <div id="column2" class="column">
                    <div class="habblet-container">
                        <div class="cbb clearfix green">
                            <h2 class="title">{function="Core::getSiteTitle($siteLang,'staff_application')"}</h2>
                            <div id="notfound-looking-for" class="box-content">
                                <p>
                                    {function="Core::getSiteTexts($siteLang,'staff_application')"}
                                </p>
                            </div>
                        </div>
                    </div>
