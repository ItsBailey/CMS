                        ...
                        <div class="cbb clearfix default">
                            ...
                            <div id="tag-search-habblet-container">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" class="search-result">
                                    <tbody>
                                       {function="incWeb::tagUserList($tag)"}
                                    </tbody>
                                </table>
                            </div>
                        </div>
                            ...
                            <div id="tag-fight-habblet-container">
                                ...
                                <div id="fightResults" class="fight-results">
                                    <div class="fight-image">
                                        <img src="{$siteLink}{$siteTemplateStyle}images/tagfight/tagfight_start.gif" alt="" name="fightanimation" id="fightanimation" />
                                        <a id="tag-fight-button" href="#" class="new-button" onclick="TagFight.init(); return false;"><b>Vecht!</b><i></i></a>
                                    </div>
                                </div>
                                <div class="tagfight-preload">
                                    <img src="{$siteLink}{$siteTemplateStyle}images/tagfight/tagfight_end_0.gif" width="1" height="1" />
                                    <img src="{$siteLink}{$siteTemplateStyle}images/tagfight/tagfight_end_1.gif" width="1" height="1" />
                                    <img src="{$siteLink}{$siteTemplateStyle}images/tagfight/tagfight_end_2.gif" width="1" height="1" />
                                    <img src="{$siteLink}{$siteTemplateStyle}images/tagfight/tagfight_loop.gif" width="1" height="1" />
                                    <img src="{$siteLink}{$siteTemplateStyle}images/tagfight/tagfight_start.gif" width="1" height="1" />
                                </div>
                            </div>
                        </div>
                    </div>
