        ...
        <div id="container">
            <div id="content">
                <div id="column1" class="column">
                    {function="incWeb::staffBox(9)"}
                    {$tplRounder}
                    
                    {function="incWeb::staffBox(8)"}
                    {$tplRounder}
                    
                    {function="incWeb::staffBox(7)"}
                    {$tplRounder}
                    
                    {function="incWeb::staffBox(6)"}
                    {$tplRounder}
                    
                    {function="incWeb::staffBox(5)"}
                    {$tplRounder}
                </div>
                ...
                <div id="column2" class="column">
                    <div class="habblet-container">
                        <div class="cbb clearfix green">
                            <h2 class="title">{function="Core::getSiteTitle($siteLang,'staff')"}</h2>
                            <div id="notfound-looking-for" class="box-content">
                                <p>
                                    {function="Core::getSiteTexts($siteLang,'staff')"}
                                </p>
                            </div>
                        </div>
                    </div>
