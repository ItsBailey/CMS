                    ...
                    <div class="content">
                                ...
                                <div class="box-content">
                                    <div id="settingsNavigation">
                                        <ul>
                                            ...
                                            <li class="selected">Motto instellingen</li>
                        ...
                        <div class="habblet-container" style="float:left; width: 560px;">
                            <div class="cbb clearfix settings">
                                <h2 class="title">Motto instellingen</h2>
                                <div class="box-content">
                                    <p>
                                    ...
                                    <form method="POST">
                                        <?php echo $editError;?>
                                        <h3>Jouw Motto</h3>
                                        <p>Dit is eigenlijk je visitekaartje, als mensen ope je klikken, lezen ze dit als eerste!</p>
                                        <p>
                                            <span class="label">Jouw Motto:</span>
                                            <input type="text" name="motto" value="<?php echo $userMotto;?>" id="avatarmotto" />
                                        </p>
                                        <div class="settings-buttons">
                                            <input type="submit" value="Wijzig je motto!" name="submit" class="submit" />
                                        </div>
                                    </form>
                                </div>
                            </div>
