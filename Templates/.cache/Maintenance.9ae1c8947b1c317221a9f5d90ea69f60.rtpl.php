...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>styles/maintenance.css" />
...
<div id="container">
    <div id="content">
        ...
        <div id="process-content">
            ...
            <div id="footer">
                <p>
                    <strong><?php echo $siteShort;?> is gemaakt door <?php echo $siteOwner;?></strong>
                </p>
                <p>
