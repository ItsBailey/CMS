        ...
        <div id="container">
            <div id="content">
                <div id="column1" class="column">
                    <?php echo incWeb::staffBox(9); ?>

                    <?php echo $tplRounder;?>

                    
                    <?php echo incWeb::staffBox(8); ?>

                    <?php echo $tplRounder;?>

                    
                    <?php echo incWeb::staffBox(7); ?>

                    <?php echo $tplRounder;?>

                    
                    <?php echo incWeb::staffBox(6); ?>

                    <?php echo $tplRounder;?>

                    
                    <?php echo incWeb::staffBox(5); ?>
                ...
                <div id="column2" class="column">
                    <div class="habblet-container">
                        <div class="cbb clearfix green">
                            <h2 class="title"><?php echo Core::getSiteTitle($siteLang,'staff'); ?></h2>
                            <div id="notfound-looking-for" class="box-content">
                                <p>
                                    <?php echo Core::getSiteTexts($siteLang,'staff'); ?>
