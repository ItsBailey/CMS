...
<head>
    ...
    <script type="text/javascript" src="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>static/js/fullcontent.js"></script>
    <script type="text/javascript" src="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>static/js/libs2.js"></script>
    <script type="text/javascript" src="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>static/js/group.js"></script>
    <script type="text/javascript" src="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>static/js/rooms.js"></script>
    <script type="text/javascript" src="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>static/js/moredata.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>v2/styles/boxes.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>v2/styles/tooltips.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>v2/styles/welcome.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>v2/styles/personal.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>v2/styles/group.css" />
    <link rel="stylesheet" type="text/css" href="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>v2/styles/rooms.css" />
    
    <script type="text/javascript">
    var andSoItBegins = (new Date()).getTime();
    document.habboLoggedIn = true;
    var habboName = <?php echo $userName;?>;
    var habboReqPath = '<?php echo $siteTemplateStyle;?>';
...
<body>
    ...
    <div id="header-container">
        <div id="header" class="clearfix">
            ...
            <ul id="navi">
                <li class=""><a href="me"><?php echo $userName;?></a><span></span></li>
