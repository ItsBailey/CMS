                                ...
                                <div class="box-content">
                                    <div id="settingsNavigation">
                                        <ul>
                                            ...
                                            <li class="selected">E-mail instellingen</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cbb clearfix settings">
                                ...
                                <div class="box-content">
                                    ...
                                    <form method="POST">
                                        ...
                                        <h3>Jouw e-mailadres veranderen</h3>
                                        <p>We gebruiken jouw e-mailadres om je te helpen bij het resetten van je wachtwoord of je informatie te sturen over het hotel zoals een nieuwsbrief.</p>
                                        <p>
                                            <span class="label">Oud e-mailadres:</span>
                                            <input type="email" name="oldemail" />
                                        </p>
                                        <p>
                                            <span class="label">Nieuw e-mailadres:</span>
                                            <input type="email" name="newemail" />
                                        </p>
                                        <p>
                                            <span class="label">Nieuw e-mailadres herhalen:</span>
                                            <input type="email" name="newemail2" />
                                        </p>
                                        <div class="settings-buttons">
                                            <input type="submit" value="Wijzig je e-mailadres!" name="submit" class="submit" />
                                        </div>
                                    </form>
                                </div>
                            </div>
