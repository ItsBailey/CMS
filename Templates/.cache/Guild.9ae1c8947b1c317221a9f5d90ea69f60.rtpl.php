            ...
            <div id="content" style="position: relative" class="clearfix">
                <div id="mypage-wrapper" class="cbb blue">
                    <div class="box-tabs-container box-tabs-left clearfix">
                        ...
                        <h2 class="page-owner">
                            <?php echo $userName;?>&nbsp;
                            <img src="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>images/status_closed_big.gif" alt="Closed Group" title="Closed Group">
                            <img src="<?php echo $siteLink;?><?php echo $siteTemplateStyle;?>images/status_exclusive_big.gif" alt="Moderated Group" title="Moderated Group">
                        </h2>
                    </div>
                </div>
            </div>