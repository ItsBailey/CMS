...
$varStaff = array(
    ...
    "siteTitle" => $siteShort." &bull; Medewerkers",
    ...
    "navSub" => '
    <li class="selected">Medewerkers</li>
...
$template->assign($varStaff);

// Maak de pagina.
$template->draw($siteTemplate.'_header');
if(Config::R('emuUsing') == 'arcturus') {
    $template->draw($siteTemplate.'Staff_Arcturus');
} else {
    $template->draw($siteTemplate.'Staff_Plus');
}
