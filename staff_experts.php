...
$varStaffExperts = array(
    // siteTile = De website titel in de url balk.
    "siteTitle" => $siteShort." &bull; Experts",
...
$template->assign($varStaffExperts);

// Maak de pagina.
$template->draw($siteTemplate.'_header');
$template->draw($siteTemplate.'StaffExperts');
